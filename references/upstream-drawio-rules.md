...
This file is a tight, opinionated digest of the rules this skill enforces. For the authoritative long-form references — vendored locally from `jgraph/drawio-mcp` (Apache-2.0) — read:

- [`drawio-xml-reference.md`](drawio-xml-reference.md) — complete XML rules: styles, edge routing, containers, layers, tags, metadata, placeholders, dark mode, well-formedness.
- [`drawio-style-reference.md`](drawio-style-reference.md) — comprehensive shape/style catalog.
