...
The skill references the shared XML generation guide (edge routing, containers, layers, tags, metadata, dark mode, etc.) from GitHub at runtime: [`shared/xml-reference.md`](../shared/xml-reference.md)
